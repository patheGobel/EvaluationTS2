...
\section*{\underline{Exercice 1 :} 4 points [\textit{ Déjà corrigé par ..}]}
...
\begin{enumerate}
    \item Montrer que la suite \((v_n)_{n \in \mathbb{N}^*}\) est géométrique.\hfill \textbf{01 pt}
    ...
    \end{enumerate}
\end{enumerate}
\section*{\underline{Exercice 2 (BAC 2022) :} 4 points [\textit{ Déjà corrigé par moi-même}]}
...
\end{enumerate}
\section*{\underline{Exercice 3 :} 4 points [\textit{ Exercice 1  du devoir N1 déjà par moi-même}]}
...
\section*{\underline{Problème :} 8 points [\textit{ Exercice d'application déjà corrigé par moi-même}]} 
