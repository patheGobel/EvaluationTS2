...
\lim_{x \to -\infty} f(x)-2x &= \lim_{x \to -\infty}x - 2 - \sqrt{x^2 - 2x}-2x\\
														&=\lim_{x \to -\infty}-x - 2 - \sqrt{x^2 - 2x}\\
																		...
																		&=-3
\end{align*}
\textcolor{green}{Donc $(\mathcal{C}_{f}) $ admet une asymptote verticale $y=2x-3$ au voisinage de $-\infty$}
...
\label{fig:monimage}
\end{figure}
\href{https://www.geogebra.org/classic/x689ax6d}{Clique ici pour voir la courbe sur géogébra}\\
\end{center}
