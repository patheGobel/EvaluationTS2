...
\[
z_{1} = \frac{-(-3+2i)-1}{2}, z_{2} = \frac{-(-3+2i)+1}{2}
\]
\[
z_{1} = \frac{3-2i-1}{2}, z_{2} = \frac{3-2i+1}{2}
\]
...
\[
z_{1} = \frac{2-2i}{2}, z_{2} = \frac{4-2i}{2}
\]

\[
\tcbhighmath[boxrule=1pt, colback=yellow!5!white, colframe=black]{ S = \left\{ 2, 2-i, 1-i \right\} }
\]
\end{enumerate}
\subsection*{ Partie B}
...
Géométriquement, $\arg(Z')$ représente l'angle orienté entre les vecteurs $\overrightarrow{MC}$ et $\overrightarrow{MA}$.
...
\centering
\includegraphics[width=0.8\textwidth]{CourbeCompoIAKedougou.png}
