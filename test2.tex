...
\newcommand{\question}{%
  ...
  \textbf{\textcolor{mygreen}{Exercice \thecorrection (1 point) :}} \ignorespaces
}
% Commande pour ajouter du texte en arrière-plan
\AddToShipoutPicture{
    \AtTextCenter{%
        \makebox[0pt]{\rotatebox{60}{\textcolor[gray]{0.9}{\fontsize{10cm}{10cm}\selectfont MATHS BAC}}}
    }
}
\begin{document}
...
\begin{center}
    \begin{tabular}{@{} p{5cm} p{5cm} p{5cm} @{}} % 3 colonnes avec largeurs fixées
        Lycée Sérère & Test 2 & 25 Octobre 2024 \\
    \end{tabular}
    \\[-0.01cm] % Ajuster l'espace vertical entre le tableau et la barre
    \hrule % Barre horizontale
\end{center}
\begin{center}
    \textbf{\Large Test 1 : Asymptotes et fonctions rationnelles} \\[0.2cm]
    \textbf{\large Professeur : Mme DIA} \\[0.2cm]
    \textbf{Classe : Terminale S2} \\[0.2cm]
    \textbf{\small Durée : 15 minutes} \\[0.2cm]
    \textbf{\small Note : /5}
\end{center}
